                                    ...
                                    <div class="card-3d-wrap mx-auto">
                                        <div class="card-3d-wrapper">
                                                    ...
                                                    <div class="section text-center">
                                                        <form method="POST" action="<?php echo e(route('login')); ?>">
                                                            ...
                                                            <div class="form-group mt-2">
                                                                <input type="email" name="email" class="form-style" placeholder="Your Email" id="logemail" autocomplete="off" value="<?php echo e(old('email')); ?>">
                                            ...
                                            <div class="card-front">
                                                <div class="center-wrap">
                                                    <div class="section text-center">
                                                        <form method="POST" action="<?php echo e(route('signup')); ?> " enctype="multipart/form-data">
                                                            <?php echo csrf_field(); ?>
                                                            <h4 class="appointment-main-title">Sign Up</h4>

                                                            <div class="form-group mt-2">
                                                                <input type="text" name="name" class="form-style" placeholder="Your Full Name" id="logname" autocomplete="off" value="<?php echo e(old('name')); ?>">
                                                            ...
                                                            <div class="form-group mt-2">
                                                                <input type="text" name="phone" class="form-style" placeholder="Your phone number" id="lognum" autocomplete="off" value="<?php echo e(old('phone')); ?>">
...
<?php /**PATH C:\Users\Orange\Desktop\project vet pet\project\resources\views/registration/signup.blade.php ENDPATH**/ ?>