         ...
         <div class="main_header">
          <div class="custom-container-fluid">
            ...
            <div class="main_top_bar">
                  <h1><figure><img src="<?php echo e(asset('images/top-logo.png')); ?>"></figure></h1>
                  <ul class="navigation">
                      <li><a href="<?php echo e(route('home')); ?>">Home</i></a>
                      ...
                      <li><a href=""> Shop<i class="fa fa-caret-down"></i></a>
                        ...
                        <li><a href="<?php echo e(route('contactUs.index')); ?>">Events </a></li>
                ...
                <div class="container">
                  <div class="sab-banner-text">
                     <h2><?php echo $__env->yieldContent('title'); ?></h2>
                      <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#"><?php echo $__env->yieldContent('from'); ?></a></li>
...
<?php /**PATH C:\Users\Orange\Desktop\project vet pet\project\resources\views/layouts/header.blade.php ENDPATH**/ ?>