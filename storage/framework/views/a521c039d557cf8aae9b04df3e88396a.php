                  ...
                  <div class="pet-ccompany-slider" style="display: flex">
                    <div>
                      <div class="pet_company_column">
                          <figure >
                            <img style="height: 100px" src="<?php echo e(asset('img/brands/brand9.jpg')); ?>" alt="">
                          </figure>
                      </div>
                    </div>
                    <div>
                      <div class="pet_company_column">
                          <figure>
                            <img style="height: 100px" src="<?php echo e(asset('img/brands/brand2.png')); ?>" alt="">
                          </figure>
                      </div>
                  </div>
                  <div>
                    <div class="pet_company_column">
                        <figure>
                          <img style="height: 100px" src="<?php echo e(asset('img/brands/brand3.jpg')); ?>" alt="">
                        </figure>
                    </div>
                  </div>
                  <div>
                    <div class="pet_company_column">
                        <figure>
                          <img style="height: 100px" src="<?php echo e(asset('img/brands/brand8.jpg')); ?>" alt="">
                        </figure>
                    </div>
                  </div>
                  <div>
                    <div class="pet_company_column">
                        <figure>
                          <img style="height: 100px" src="<?php echo e(asset('img/brands/brand5.jpg')); ?>" alt="">
                        </figure>
                    </div>
                  </div>
                  <div>
                    <div class="pet_company_column">
                        <figure>
                          <img style="height: 100px" src="<?php echo e(asset('img/brands/brand6.png')); ?>" alt="">
                        </figure>
                    </div>
                  </div>
                  <div>
                    <div class="pet_company_column">
                        <figure>
                          <img style="height: 100px" src="<?php echo e(asset('img/brands/brand7.png')); ?>" alt="">
                        </figure>
                    </div>
                  </div>
                </div>
...
<?php /**PATH C:\Users\Orange\Desktop\project vet pet\project\resources\views/layouts/footer.blade.php ENDPATH**/ ?>