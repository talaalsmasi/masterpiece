...
<html lang="en">
    <head>
        ...
        <title>service grid 02 Page</title>
        <!-- Bootstrap core CSS -->
    ...
    <body class="">
      <!-- main header  start -->
        ...
        <!-- main header  start -->
         ...
         <!--pet ser wraper end-->
  			  <section class="pet_sevice_wrapper">
            <div class="custom-container">
                <div class="pet_service02_row service_grid02">
              ...
              <div class="container">
                <div class="pet_widget_row">
                  <div class="pet_widget_column">
                    ...
                    <p>ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis </p>
                  ...
                  <div class="pet_widget_column widget_news">
                     ...
                     <div class="pet_widget_newslater">
                        <p>you will be notified wen somthing new  will be appear</p>
