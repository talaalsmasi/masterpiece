            ...
            <section>
                ...
                <script>
                    document.addEventListener('DOMContentLoaded', function () {
                        ...
                        const appointmentDateSection = document.getElementById('appointment_date-section');
                        const timeSelect = document.getElementById('appointment_time');

                        const bookedAppointments = @json($bookedAppointments); // Add booked times data

                        function toggleSections() {
                            if (serviceSelect.value == 1) { // Service ID 1 (requires doctor)
                                doctorSection.style.display = 'block';
                                timeSection.style.display = 'block';
                                appointmentDateSection.style.display = 'block';
                            } else if (serviceSelect.value == 2 || serviceSelect.value == 3) { // Services without doctor
                                ...
                                appointmentDateSection.style.display = 'none';
                            }
                        }
                        ...
                        function disableBookedTimes() {
                            ...
                            if (selectedDate && selectedDoctor) {
                                timeSelect.querySelectorAll('option').forEach(function(option) {
                                    const optionTime = selectedDate + ' ' + option.value + ' ' + selectedDoctor;

                                    if (bookedAppointments.includes(optionTime)) {
                        ...
                        document.getElementById('appointment_date').addEventListener('change', disableBookedTimes);

                        toggleSections();
                        disableBookedTimes(); // Disable booked times on initial load
                    });
                </script>
