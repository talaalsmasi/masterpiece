                  ...
                  <div class="sab-banner-text">
                     <h2>shop listing</h2>
                      <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">shop listing</li>
                      </ul>
                  </div>
                </div>
                   ...
                   <div class="pet_shop_row">
                      <div class="pet_shop_column">
                        <figure>
                          ...
                          <a class="pet_heart_icon" href=""><i class="fa fa-heart"></i></a>
                        </figure>
                        <div class="pet_shop_text">
                          <h4>feline greenies</h4>
                          <span>Dog & cats</span>
                          <div class="product_price">
                            <h6><a href="#">$80.00</a></h6>
                      ...
                      <div class="pet_shop_column">
                        <figure>
                          <img src="images/food-03.jpg" alt="">
                          <a class="pet_heart_icon" href=""><i class="fa fa-heart"></i></a>
                        </figure>
                        <div class="pet_shop_text">
                          <h4>feline greenies</h4>
                      ...
                      <div class="pet_shop_column">
                        <figure>
                          <img src="images/food-04.jpg" alt="">
                          <a class="pet_heart_icon" href=""><i class="fa fa-heart"></i></a>
                        </figure>
                        <div class="pet_shop_text">
                          <h4>feline greenies</h4>
                      ...
                      <div class="loadmore_btn">
                        <a class="main_button btn2 bdr-clr hover-affect" href="#">loadmore</a>
                      </div>
                   </div>
                </div>
              </section>   
