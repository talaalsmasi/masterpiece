...
<html lang="en">
    <head>
        ...
        <title>Blog Post grid  page</title>
        <!-- Bootstrap core CSS -->
            ...
            <div class="sab-banner-text">
               <h2>Blog Post</h2>
                <ul class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">blog post full</li>
                </ul>
            </div>
          </div>
            ...
            <div class="child_service_row">
        			  <div class="child_service_column">
          				...
          				<div class="child_service_text">
          					<h5>Chid Education Always Ideas <br> For Knoeledge</h5>
                    ...
                    <div class="child_service_botton_fig">
                      <figure><img src="images/shap-fig02.png" alt=""></figure>
                      <a href="#">By Berlin Jhone</a>
                    </div>
          				</div>
        			  </div>
        			  ...
        			  <div class="child_service_column">
                  <figure class="image-layer-affect">
                    <img src="extra-images/blog-grid-post01.jpg" alt="">
                  </figure>
                  <div class="child_service_text">
                    <h5>Chid Education Always Ideas <br> For Knoeledge</h5>
                    <ul class="child_service_info">
                    ...
                    <p>Dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse</p>
                    <div class="child_service_botton_fig">
                      <figure><img src="images/shap-fig01.png" alt=""></figure>
                      <a href="#">By Berlin Jhone</a>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="child_service_text">
                    ...
                    <div class="child_service_botton_fig">
        			  ...
        			  <div class="child_service_column">
                  <figure class="image-layer-affect">
                    <img src="extra-images/blog-grid-post04.jpg" alt="">
                  </figure>
                  <div class="child_service_text">
                    <h5>Chid Education Always Ideas <br> For Knoeledge</h5>
                    <ul class="child_service_info">
                    ...
                    <p>Dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse</p>
                    <div class="child_service_botton_fig">
                      <figure><img src="images/shap-fig03.png" alt=""></figure>
                      <a href="#">By Berlin Jhone</a>
                    </div>
                  </div>
                </div>
